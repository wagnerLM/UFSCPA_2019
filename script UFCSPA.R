# Script simpósio UFCSPA
# Contato: wagner.machado@pucrs.br
...
dasspoly_g<-qgraph(cor_auto(dasspoly),groups=dassgroups,nodeNames=dasslabels,layout="spring",legend.cex=.3,graph="glasso",sampleSize=nrow(dasspoly),threshold=T,palette="pastel")
